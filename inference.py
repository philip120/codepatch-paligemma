...
def main():
    ...
    # The model was not trained on instructions, but on direct code-to-description.
    # The correct prompt is the beginning-of-sequence token.
    prompt_text = processor.text_tokenizer.bos_token
